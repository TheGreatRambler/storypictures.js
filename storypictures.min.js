...
function(a,l,d,f){return 40>.2126*a+.7152*l+.0722*d?!0:!1});f=d(1,a.solidityFunc);f=1*Math.sqrt(a.story.length/(2*f.spotsopen));var p=d(f,a.solidityFunc);return function(a,d){function f(a,c){e?"[object Object]"===Object.prototype.toString.call(d[b])?d[b].c?h.draw(a,c,d[b].n,d[b].c):h.draw(a,c,d[b]):h.draw(a,c,d[b]):h.draw(a,c,d.charAt(b));b++}for(var h=new ROT.Display({width:2*a.width,height:a.height,forceSquareRatio:!1,fontSize:12,bg:"#FFFFFF",fg:"#000000"}),b=0,e=story.constructor===Array,g=0;g<
a.height;g++)for(var c=0;c<a.width;c++)a.pixels[c>=g?c*c+c+g:g*g+c]&&(f(2*c,g),f(2*c+1,g));return h._context}(d(Math.sqrt(a.story.length/(2*p.spotsopen))*f,a.solidityFunc),a.story)}});

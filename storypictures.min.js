...
8&255,n=data32[i]&255;e(d,l,m,n)?k[c]=!1:(f++,k[c]=!0)}return{pixels:k,spotsopen:f,width:b.canvas.width,height:b.canvas.height}}if(a.img instanceof HTMLImageElement){var g=document.createElement("canvas");g.width=a.img.width;g.height=a.img.height;var d=g.getContext("2d");d.drawImage(a.img,0,0)}else if(a.img instanceof CanvasRenderingContext2D)g=a.img.context,d=a.img;else throw new TypeError("Image must be canvas, context, or image element");a.solidityFunc||(a.solidityFunc=function(a,d,e,f){return 40>

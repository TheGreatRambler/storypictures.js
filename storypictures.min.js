...
8&255,n=data32[i]&255;e(d,l,m,n)?k[c]=!1:(f++,k[c]=!0)}return{pixels:k,spotsopen:f,width:b.canvas.width,height:b.canvas.height}}if(a.img instanceof HTMLImageElement){var g=document.createElement("canvas");g.width=a.img.width;g.height=a.img.height;var d=g.getContext("2d");d.drawImage(a.img,0,0)}else if(a.img instanceof CanvasRenderingContext2D)g=a.img.context,d=a.img;else throw new TypeError("Image must be canvas, context, or image element");a.story=a.story.replace(/(?:\r\n|\r|\n)/g,"");a.solidityFunc||
(a.solidityFunc=function(a,d,e,f){return 40>.2126*a+.7152*d+.0722*e?!0:!1});d=e(1,a.solidityFunc);d=1*Math.sqrt(a.story.length/(2*d.spotsopen));var p=e(d,a.solidityFunc);return function(a,d){for(var e=new ROT.Display({width:2*a.width,height:a.height,forceSquareRatio:!1,fontSize:12,bg:"#FFFFFF",fg:"#000000"}),f=0,b=0;b<a.height;b++)for(var c=0;c<a.width;c++)a.pixels[c>=b?c*c+c+b:b*b+c]&&(e.draw(2*c,b,d.charAt(f)),f++,e.draw(2*c+1,b,d.charAt(f)),f++);return e._context}(e(Math.sqrt(a.story.length/(2*
p.spotsopen))*d,a.solidityFunc),a.story)}});
